...
const IntegrateSection = () => {
  return (
    <section className='relative flex h-screen w-full items-center justify-center gap-10 overflow-hidden bg-aerospace_yellow-900'>
      <OrbitingIntegrations />
      <div className='flex w-[400px] flex-col gap-4'>
        <h1 className='text-3xl font-bold text-rose-200'>Integrate with your Notion, Github, Drive and more</h1>
        <p className='text-base font-light text-rose-100'>
